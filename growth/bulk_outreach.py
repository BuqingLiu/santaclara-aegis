...
REGION_CAP = {"mi": 16, "ca": 10, "sz": 4, "tx": 12}   # 合计 42/天（2026-08-13 上调：原 35/天在漏跑多日后剩 11 工作日无法补足 500 首触缺口；42/天×11+已发62≈524≥500。仍是真人节奏——MI 16 封摊一天≈每 25 分钟 1 封；且受全局 45 硬上限 + 163 限额即停双重保护，绝不顶到风控线）
# 全局日发信硬上限（四区域叠加后也不得超过）。远低于 163 风控线，双重保险：
# ① 防补发日各区域 2x 叠加一天爆量（MI32+TX24+CA20+SZ8=84 会触发 163 日限额）；
